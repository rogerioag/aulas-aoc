...
echo "RAG: p4a -v -k --c-flags=\"-lm\" --cpp-flags=\"-lm\" --cxx-flags=\"-lm\" --ld-flags=\"-lm\" --openmp $PROGNAME.c -o $PROGNAME-openmp" >> p4a-saida-openmp.txt
p4a -v -k --c-flags="-lm" --cpp-flags="-lm" --cxx-flags="-lm" --ld-flags="-lm" --openmp $PROGNAME.c -o $PROGNAME-openmp 2>> p4a-saida-openmp.txt
...
echo "RAG: p4a -v -k --c-flags=\"-lm\" --cpp-flags=\"-lm\" --cxx-flags=\"-lm\" --ld-flags=\"-lm\" --openmp $PROGNAME.c -o $PROGNAME-openmp-accel" >> p4a-saida-openmp-accel.txt
p4a -v -k --c-flags="-lm" --cpp-flags="-lm" --cxx-flags="-lm" --ld-flags="-lm" --accel --openmp $PROGNAME.c -o $PROGNAME-openmp-accel 2>> p4a-saida-openmp-accel.txt
...
echo "RAG: p4a -v -k --c-flags=\"-lm\" --cpp-flags=\"-lm\" --cxx-flags=\"-lm\" --ld-flags=\"-lm\" --openmp $PROGNAME.c -o $PROGNAME-opencl" >> p4a-saida-opencl.txt
p4a -v -k --c-flags="-lm" --cpp-flags="-lm" --cxx-flags="-lm" --ld-flags="-lm" --accel --openmp $PROGNAME.c -o $PROGNAME-opencl 2>> p4a-saida-opencl.txt
