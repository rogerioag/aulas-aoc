...
*/
extern void P4A_copy_from_accel(size_t element_size, void *host_address, const void *accel_address);
...
*/
extern void P4A_copy_to_accel(size_t element_size, const void *host_address, void *accel_address);
...
/** Stub for copying memory from the host to the hardware accelerator.
    ...
    and not some address in some memory space.
*/
extern void P4A_copy_from_accel_1d(size_t element_size, size_t d1_size, size_t d1_block_size, size_t d1_offset, void *host_address, const void *accel_address);
...
*/
extern void P4A_copy_to_accel_1d(size_t element_size, size_t d1_size, size_t d1_block_size, size_t d1_offset, const void *host_address, void *accel_address);
...
*/
extern void P4A_copy_to_accel_2d(size_t element_size, size_t d1_size, size_t d2_size, size_t d1_block_size, size_t d2_block_size, size_t d1_offset, size_t d2_offset, const void *host_address, void *accel_address);
...
/** Stub for copying memory from the hardware accelerator to a 2D array in
    the host.
*/
extern void P4A_copy_from_accel_2d(size_t element_size, size_t d1_size, size_t d2_size, size_t d1_block_size, size_t d2_block_size, size_t d1_offset, size_t d2_offset, void *host_address, const void *accel_address);
...
/** Stub for copying memory from the hardware accelerator to a 3D array in
    the host.
*/
extern void P4A_copy_from_accel_3d(size_t element_size, size_t d1_size, size_t d2_size, size_t d3_size, size_t d1_block_size, size_t d2_block_size, size_t d3_block_size, size_t d1_offset, size_t d2_offset, size_t d3_offset, void *host_address, const void *accel_address);
...
/** Stub for copying a 3D memory zone from the host to a compact memory
    zone in the hardware accelerator.
*/
extern void P4A_copy_to_accel_3d(size_t element_size, size_t d1_size, size_t d2_size, size_t d3_size, size_t d1_block_size, size_t d2_block_size, size_t d3_block_size, size_t d1_offset, size_t d2_offset, size_t d3_offset, const void *host_address, void *accel_address);
...
/** Stub for copying memory from the hardware accelerator to a 4D array in
    the host.
*/
extern void P4A_copy_from_accel_4d(size_t element_size, size_t d1_size, size_t d2_size, size_t d3_size, size_t d4_size, size_t d1_block_size, size_t d2_block_size, size_t d3_block_size, size_t d4_block_size, size_t d1_offset, size_t d2_offset, size_t d3_offset, size_t d4_offset, void *host_address, const void *accel_address);
...
/** Stub for copying a 4D memory zone from the host to a compact memory
    zone in the hardware accelerator.
*/
extern void P4A_copy_to_accel_4d(size_t element_size, size_t d1_size, size_t d2_size, size_t d3_size, size_t d4_size, size_t d1_block_size, size_t d2_block_size, size_t d3_block_size, size_t d4_block_size, size_t d1_offset, size_t d2_offset, size_t d3_offset, size_t d4_offset, const void *host_address, void *accel_address);
...
*/
extern void P4A_accel_malloc(void **address, size_t size);
...
*/
extern void P4A_accel_free(void *address);
 


/** Stubs for P4A runtime */
extern void P4A_runtime_copy_to_accel(void *host_ptr, size_t size);
 
extern void P4A_runtime_copy_from_accel(void *host_ptr, size_t size);
 
extern void *P4A_runtime_host_ptr_to_accel_ptr(void *host_ptr, size_t size);
