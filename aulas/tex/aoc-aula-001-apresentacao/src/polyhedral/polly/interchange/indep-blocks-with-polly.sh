...
echo "3c. Independent Blocks."
${PATH_TO_LLVM_BUILD}/bin/opt -load ${PATH_TO_POLLY_LIB}/LLVMPolly.so -basicaa -polly-independent -S ${BENCHMARK}.ll > ${BENCHMARK}_indep_blocks.ll
