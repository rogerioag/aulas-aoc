...
entry.split:                                      ; preds = %entry
  br label %_bb_5_preheader

_bb_4_:                                         ; preds = %_bb_5_preheader, %_bb_4_
  %indvar = phi i64 [ 0, %_bb_5_preheader ], [ %indvar.next, %_bb_4_ ]
  ...
  br i1 %exitcond1, label %_bb_6_, label %_bb_4_

_bb_6_:                                         ; preds = %_bb_4_
  %indvar.next3 = add i64 %indvar2, 1
  %exitcond = icmp eq i64 %indvar.next3, 4
  br i1 %exitcond, label %_bb_8_, label %_bb_5_preheader

_bb_5_preheader:                               ; preds = %_bb_6_, %entry.split
  %indvar2 = phi i64 [ %indvar.next3, %_bb_6_ ], [ 0, %entry.split ]
