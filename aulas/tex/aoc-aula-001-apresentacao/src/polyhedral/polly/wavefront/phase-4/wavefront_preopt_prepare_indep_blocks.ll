; ModuleID = 'wavefront_preopt_prepare.ll'
...
"<bb 4>":                                         ; preds = %"<bb 5>.preheader", %"<bb 4>"
  ...
  %ar5 = getelementptr [5 x [5 x i32]]* @A, i64 0, i64 %"indvars.iv.next13.moved.to.<bb 4>", i64 %0
  %1 = add i64 %indvar, 2
  %ar7 = getelementptr [5 x [5 x i32]]* @A, i64 0, i64 %".moved.to.<bb 4>", i64 %1
  %ar9 = getelementptr [5 x [5 x i32]]* @A, i64 0, i64 %".moved.to.<bb 4>", i64 %0
