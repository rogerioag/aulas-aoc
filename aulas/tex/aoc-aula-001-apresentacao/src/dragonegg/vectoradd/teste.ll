...
@.str4 = private unnamed_addr constant [15 x i8] c"Computations:\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %1 = load %struct._IO_FILE** @stdout, align 8
  %2 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([15 x i8]* @.str4, i32 0, i32 0))
  br label %3
...
; <label>:4                                       ; preds = %3
  ...
  %5 = load float* %scevgep2.moved.to., align 4
  %6 = load float* %scevgep1.moved.to., align 4
  %7 = fadd float %5, %6
  store float %7, float* %scevgep.moved.to., align 4
  br label %8
