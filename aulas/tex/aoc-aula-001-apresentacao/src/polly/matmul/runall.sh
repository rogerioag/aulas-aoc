...
export PATH=$PATH:/dados/rogerio/USP/doutorado/polly/llvm_build/Debug+Asserts/bin
...
export PATH_TO_POLLY_LIB="/dados/rogerio/USP/doutorado/polly/llvm_build/tools/polly/Debug+Asserts/lib"
