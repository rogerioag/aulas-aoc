...
@A = common global [10 x [10 x float]] zeroinitializer, align 16
@B = common global [10 x [10 x float]] zeroinitializer, align 16
@stdout = external global %struct._IO_FILE*
@.str = private unnamed_addr constant [5 x i8] c"%lf \00", align 1
@C = common global [10 x [10 x float]] zeroinitializer, align 16
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [10 x [10 x float]]* @A, i32 0, i64 %idxprom5
  %arrayidx6 = getelementptr inbounds [10 x float]* %arrayidx, i32 0, i64 %idxprom
  ...
  %arrayidx15 = getelementptr inbounds [10 x [10 x float]]* @B, i32 0, i64 %idxprom14
  %arrayidx16 = getelementptr inbounds [10 x float]* %arrayidx15, i32 0, i64 %idxprom13
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [10 x [10 x float]]* @C, i32 0, i64 %idxprom4
  %arrayidx5 = getelementptr inbounds [10 x float]* %arrayidx, i32 0, i64 %idxprom
...
for.body8:                                        ; preds = %for.cond6
  ...
  %arrayidx11 = getelementptr inbounds [10 x [10 x float]]* @C, i32 0, i64 %idxprom10
  %arrayidx12 = getelementptr inbounds [10 x float]* %arrayidx11, i32 0, i64 %idxprom9
  %7 = load float* %arrayidx12, align 4
  %8 = load i32* %k, align 4
  %idxprom13 = sext i32 %8 to i64
  %9 = load i32* %i, align 4
  %idxprom14 = sext i32 %9 to i64
  %arrayidx15 = getelementptr inbounds [10 x [10 x float]]* @A, i32 0, i64 %idxprom14
  %arrayidx16 = getelementptr inbounds [10 x float]* %arrayidx15, i32 0, i64 %idxprom13
  ...
  %arrayidx19 = getelementptr inbounds [10 x [10 x float]]* @B, i32 0, i64 %idxprom18
  %arrayidx20 = getelementptr inbounds [10 x float]* %arrayidx19, i32 0, i64 %idxprom17
  ...
  %arrayidx23 = getelementptr inbounds [10 x [10 x float]]* @C, i32 0, i64 %idxprom22
  %arrayidx24 = getelementptr inbounds [10 x float]* %arrayidx23, i32 0, i64 %idxprom21
