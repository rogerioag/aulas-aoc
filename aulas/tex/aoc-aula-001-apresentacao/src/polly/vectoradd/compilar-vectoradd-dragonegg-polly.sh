...
# Tirar o grafo dos scops.
# ${OPT} -basicaa -dot-scops-only -disable-output ${BENCHMARK}.polly.interchanged.ll
# ${OPT} -basicaa -dot-scops-only -disable-output ${BENCHMARK}.polly.interchanged+tiled.ll
${OPT} -basicaa -dot-scops-only -disable-output ${BENCHMARK}.polly.interchanged+tiled+vector.ll
# ${OPT} -basicaa -dot-scops-only -disable-output ${BENCHMARK}.polly.interchanged+tiled+function.ll
