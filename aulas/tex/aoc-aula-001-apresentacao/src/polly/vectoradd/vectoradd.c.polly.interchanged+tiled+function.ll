...
codeRepl2:                                        ; preds = %entry
  call void @main_polly.loop_header(i8* %0, i8* %1)
  br label %polly.loop_header.polly.loop_header19_crit_edge

polly.loop_header.polly.loop_header19_crit_edge:  ; preds = %codeRepl2
  br label %codeRepl1

codeRepl1:                                        ; preds = %polly.loop_header.polly.loop_header19_crit_edge
  call void @main_polly.loop_header19(i8* %0, i8* %1, i8* %2)
  br label %polly.loop_header19.9_crit_edge

polly.loop_header19.9_crit_edge:                  ; preds = %codeRepl1
  br label %codeRepl
}
...
; Function Attrs: nounwind
define internal void @main_polly.loop_header19(i8*, i8*, i8*) #1 {
newFuncRoot:
  br label %polly.loop_header19

polly.loop_header19.9_crit_edge.exitStub:         ; preds = %polly.loop_header19
  ret void

polly.loop_header19:                              ; preds = %newFuncRoot, %polly.loop_header19.polly.loop_header19_crit_edge
  %polly.indvar22 = phi i64 [ %polly.indvar_next23, %polly.loop_header19.polly.loop_header19_crit_edge ], [ 0, %newFuncRoot ]
  ...
  br i1 %exitcond2, label %polly.loop_header19.9_crit_edge.exitStub, label %polly.loop_header19.polly.loop_header19_crit_edge
...
; Function Attrs: nounwind
define internal void @main_polly.loop_header(i8*, i8*) #1 {
newFuncRoot:
  br label %polly.loop_header

polly.loop_header.polly.loop_header19_crit_edge.exitStub: ; preds = %polly.loop_header
  ret void

polly.loop_header:                                ; preds = %newFuncRoot, %polly.loop_header.polly.loop_header_crit_edge
  %polly.indvar = phi i64 [ 0, %newFuncRoot ], [ %polly.indvar_next, %polly.loop_header.polly.loop_header_crit_edge ]
  ...
  br i1 %exitcond3, label %polly.loop_header.polly.loop_header19_crit_edge.exitStub, label %polly.loop_header.polly.loop_header_crit_edge
